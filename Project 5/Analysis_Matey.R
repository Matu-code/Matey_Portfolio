...
#Loading the data
text_data <- read_csv("C:/Users/mened/OneDrive/Desktop/Portfolio/Project 5/Data/df_text_2023-10-27.csv.csv")
num_data <- read_csv("C:/Users/mened/OneDrive/Desktop/Portfolio/Project 5/df_num_2023-10-27.csv")
